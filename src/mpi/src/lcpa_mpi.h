...
//	cfg->add_disk(disk);
	...
	case 0: 
		...
		isRight = static_cast<int>(checkProcedure<TupleB, AscSorterB>(mAscSorterB));
		
		break;

	case 1:
		isRight = static_cast<int>(checkProcedure<TupleC, AscSorterC>(mAscSorterC1));

		break;

	case 2:
		isRight = static_cast<int>(checkProcedure<TupleC, AscSorterC>(mAscSorterC2));
